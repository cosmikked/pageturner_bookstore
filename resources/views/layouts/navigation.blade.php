    ...
    <div class="container-fluid">
        <div class="d-flex flex-wrap align-items-center justify-content-start justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 gap-3">
                <li>
                    <a href="{{ route('home') }}" class="nav-link px-2 link-body-emphasis">Home</a>
                </li>
                <li>
                    <a href="{{ route('store.catalog') }}" class="nav-link px-2 link-body-emphasis">Books</a>
                </li>
            </ul>
            ...
            <div class="d-flex align-items-center gap-4">
                ...
                <a href="{{ route('store.cart.index')}}" class="btn position-relative">
                    ...
                    <span
                        class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">{{ count(session('cart', [])) }}</span>
                </a>
                ...
                @else
                    <div class="dropdown d-flex align-items-center">
                        ...
                        <a href="{{ route('profile.edit') }}"
                            class="btn dropdown-toggle dropdown-toggle-split ms-2 p-0 border-0 bg-transparent shadow-none"
                            data-bs-toggle="dropdown" aria-expanded="false" style="line-height: 1;">
                            <span class="visually-hidden">Toggle Dropdown</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{ route('profile.edit') }}">My Orders</a></li>
                            <li>
